    ...
    <header>
      <div className="container space-y-6 flex flex-col items-start justify-between md:flex-row md:items-end lg:items-end">
        ...
        <div className="flex flex-col gap-4 md:px-0">
          ...
          {/**Titulo */}
          <h1 className="text-balance text-start md:text-left text-heading-lg md:text-heading-xl max-w-2xl text-gray-100">Transformando seu negócio em uma loja virtual</h1>
        </div>
      </div>
    </header>
    {/**Search */}
